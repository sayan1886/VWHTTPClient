//
//  VWHTTPDownloadRequestOperation.m
//  VWHTTPClient
//
...
typedef void (^AFURLConnectionProgressiveOperationProgressBlock)(VWHTTPDownloadRequestOperation *operation, NSInteger bytes, long long totalBytes, long long totalBytesExpected, long long totalBytesReadForFile, long long totalBytesExpectedToReadForFile);

@interface VWHTTPDownloadRequestOperation() {
    NSError *_fileError;
    id _responseObject;
}
...
@implementation VWHTTPDownloadRequestOperation
...
- (void)setProgressiveDownloadProgressBlock:(void (^)(VWHTTPDownloadRequestOperation *operation, NSInteger bytesRead, long long totalBytesRead, long long totalBytesExpected, long long totalBytesReadForFile, long long totalBytesExpectedToReadForFile))block {
